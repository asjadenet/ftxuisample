...
// configuration step. It creates a namespace called `ftxuisample`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        ftxuisample::cmake::project_name,
        ftxuisample::cmake::project_version));// version string, acquired
